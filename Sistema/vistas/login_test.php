...
<head>
    ...
    <title>InteracMath - Inicio</title>
...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="" method="POST">
			...
			<button  type="submit">Crear la cuenta</button>
		</form>
	</div>
	<div class="form-container sign-in-container">
		<form action="" method="POST">
			...
			<a href="#" class="social"><i class="fas fa-brain"></i></a>
			</div>
	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-left">
				...
				<p>Para mantenerte conectado usa tus credenciales para</p>
...
.overlay {
	background: #FF416C;
	background: -webkit-linear-gradient(to left, #4c2bff, #FF416C);
	background: linear-gradient(to left, #4c2bff, #FF416C);
